...
CFLAGS_PYEMBED = ['-g', '-fwrapv', '-O2', '-g', '-fstack-protector-strong', '-g', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects', '-fno-strict-aliasing']
CFLAGS_PYEXT = ['-pthread', '-g', '-fwrapv', '-O2', '-g', '-fstack-protector-strong', '-g', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects', '-fno-strict-aliasing']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-g', '-fwrapv', '-O2', '-g', '-fstack-protector-strong', '-g', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects', '-fno-strict-aliasing']
CXXFLAGS_PYEXT = ['-pthread', '-g', '-fwrapv', '-O2', '-g', '-fstack-protector-strong', '-g', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects', '-fno-strict-aliasing']
...
EXAMPLE_DIRECTORIES = ['traffic-control', 'naming', 'udp-client-server', 'ipv6', 'udp', 'matrix-topology', 'stats', 'realtime', 'routing', 'tcp', 'wireless', 'energy', 'tutorial', 'error-model', 'socket']
...
LIBPATH_PYEMBED = ['/usr/lib/python3.6/config-3.6m-x86_64-linux-gnu']
LIBPATH_PYEXT = ['/usr/lib/python3.6/config-3.6m-x86_64-linux-gnu']
LIBPATH_PYTHON3.6M = ['/usr/lib/python3.6/config-3.6m-x86_64-linux-gnu']
LIBPATH_ST = '-L%s'
LIB_BOOST = ['boost_system', 'boost_signals', 'boost_filesystem']
LIB_GSL = ['gsl', 'gslcblas', 'm']
LIB_LIBXML2 = ['xml2']
LIB_PYEMBED = ['python3.6m']
LIB_PYEXT = ['python3.6m']
LIB_PYTHON3.6M = ['python3.6m']
LIB_RT = ['rt']
LIB_ST = '-l%s'
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/liuchang/workspace/ns-allinone-3.32/ns-3.32/build/lib', '/home/liuchang/workspace/ns-allinone-3.32/ns-3.32/build']
...
cfg_files = ['/home/liuchang/workspace/ns-allinone-3.32/ns-3.32/build/ns3/config-store-config.h', '/home/liuchang/workspace/ns-allinone-3.32/ns-3.32/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
...
define_key = ['HAVE_SYS_IOCTL_H', 'HAVE_IF_NETS_H', 'HAVE_NET_ETHERNET_H', 'HAVE_IF_TUN_H', 'HAVE_PACKET_H', 'HAVE_NETMAP_USER_H', 'HAVE_SEMAPHORE_H', 'HAVE_GSL']
